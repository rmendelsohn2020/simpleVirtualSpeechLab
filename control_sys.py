...
class XBasedController(ControlSystem, PlotMixin):
    def simulate(self):
...
class QBasedController(ControlSystem, PlotMixin):
    def simulate(self):
...
if arch == 'x_based':
    system = XBasedController(A, B, C, ref_type)
elif arch == 'q_based':
    system = QBasedController(A, B, C, ref_type)
...
# ###Simulation with chosen architecture
# if arch == 'x_based':
